#ifndef POLYGLOT_CODEANALYSIS_CORE_SYNTAXNODEFLAGS_H
#define POLYGLOT_CODEANALYSIS_CORE_SYNTAXNODEFLAGS_H
...
#endif // POLYGLOT_CODEANALYSIS_CORE_SYNTAXNODEFLAGS_H
