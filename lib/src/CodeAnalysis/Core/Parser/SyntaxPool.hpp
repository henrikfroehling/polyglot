#ifndef POLYGLOT_CODEANALYSIS_CORE_PARSER_SYNTAXPOOL_H
#define POLYGLOT_CODEANALYSIS_CORE_PARSER_SYNTAXPOOL_H
...
#endif // POLYGLOT_CODEANALYSIS_CORE_PARSER_SYNTAXPOOL_H
