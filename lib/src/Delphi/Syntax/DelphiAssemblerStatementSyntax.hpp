#ifndef POLYGLOT_DELPHI_SYNTAX_DELPHIASSEMBLERSTATEMENTSYNTAX_H
#define POLYGLOT_DELPHI_SYNTAX_DELPHIASSEMBLERSTATEMENTSYNTAX_H
...
#endif // POLYGLOT_DELPHI_SYNTAX_DELPHIASSEMBLERSTATEMENTSYNTAX_H
