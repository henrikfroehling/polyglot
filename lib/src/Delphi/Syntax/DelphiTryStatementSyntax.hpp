#ifndef POLYGLOT_DELPHI_SYNTAX_DELPHITRYSTATEMENTSYNTAX_H
#define POLYGLOT_DELPHI_SYNTAX_DELPHITRYSTATEMENTSYNTAX_H
...
#endif // POLYGLOT_DELPHI_SYNTAX_DELPHITRYSTATEMENTSYNTAX_H
