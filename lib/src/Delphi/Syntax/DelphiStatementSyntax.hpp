#ifndef POLYGLOT_DELPHI_SYNTAX_DELPHISTATEMENTSYNTAX_H
#define POLYGLOT_DELPHI_SYNTAX_DELPHISTATEMENTSYNTAX_H
...
#endif // POLYGLOT_DELPHI_SYNTAX_DELPHISTATEMENTSYNTAX_H
