      ...
      _isBranchTaken{isBranchTaken}
{
    ...
    static_cast<SyntaxToken*>(_pElseKeyword)->setTriviaParent(this);
                                                                         ...
                                                                         bool isBranchTaken) noexcept
{
    ...
    return static_cast<DelphiElseDirectiveTriviaSyntax*>(syntaxFactory.addSyntaxTrivia(std::move(ptrElseDirectiveTrivia)));
}
