#ifndef POLYGLOT_DELPHI_SYNTAX_TRIVIA_DELPHIBADDIRECTIVETRIVIASYNTAX_H
#define POLYGLOT_DELPHI_SYNTAX_TRIVIA_DELPHIBADDIRECTIVETRIVIASYNTAX_H
...
class DelphiBadDirectiveTriviaSyntax : public Core::Syntax::DirectiveTriviaSyntax
{
public:
    explicit DelphiBadDirectiveTriviaSyntax(Core::Syntax::SyntaxKind syntaxKind,
                                            Core::Syntax::ISyntaxToken* startToken,
                                            Core::Syntax::ISyntaxToken* identifier,
                                            Core::Syntax::ISyntaxToken* endOfDirectiveToken,
                                            bool isActive) noexcept;

    virtual ~DelphiBadDirectiveTriviaSyntax() noexcept {}
    ...
    inline virtual pg_string typeName() const noexcept override { return L"DelphiBadDirectiveTriviaSyntax"; }

    static DelphiBadDirectiveTriviaSyntax* create(Core::Syntax::SyntaxFactory& syntaxFactory,
                                                  Core::Syntax::ISyntaxToken* startToken,
                                                  Core::Syntax::ISyntaxToken* identifier,
                                                  Core::Syntax::ISyntaxToken* endOfDirectiveToken,
                                                  bool isActive) noexcept;
...
#endif // POLYGLOT_DELPHI_SYNTAX_TRIVIA_DELPHIBADDIRECTIVETRIVIASYNTAX_H
