...
public:
    ...
    inline Core::Syntax::ISyntaxToken* firstToken() const noexcept override final { return _pIdentifier; }
    inline Core::Syntax::ISyntaxToken* lastToken() const noexcept override final { return _pCloseParenthesisToken; }
