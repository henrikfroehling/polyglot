...
public:
    ...
    LinePosition(const LinePosition& other) noexcept;
    LinePosition(LinePosition&& other) noexcept;
    LinePosition& operator=(LinePosition other) noexcept;
    ...
    friend void swap(LinePosition& lhs,
