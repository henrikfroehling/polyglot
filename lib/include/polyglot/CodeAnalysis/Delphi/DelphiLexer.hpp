...
private:
    Ptr<SyntaxToken> lex(LexerMode mode) noexcept override;
    ...
    Ptr<SyntaxNode> lexSingleDirective(bool isActive,
                                       bool endIsActive,
